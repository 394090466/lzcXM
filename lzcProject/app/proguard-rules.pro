...
-keepclasseswithmembers class * extends android.webkit.WebView{
    private void init();
}

-keep class com.tdr.lizijinfu_project.common.JavaScriptObject{ *; }
#-keep class com.tdr.lizijinfu_project.widgets.ObservableWebView{ *; }
